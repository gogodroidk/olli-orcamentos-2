          ...
          <AnimatedEntrance index={0}>
            <View style={styles.hero}>
              <Text style={styles.heroKicker}>
                {fase === 'ouvindo' ? 'OUVINDO…' : fase === 'enviando' ? 'MONTANDO…' : 'TOQUE E FALE'}
              </Text>
              ...
              <Text style={styles.heroHint}>
                {fase === 'enviando'
                  ...
                  : 'Neste aparelho a voz não está disponível — escreva abaixo o que você precisa que eu monto o orçamento.'}
              </Text>

              {!vozOk && !isWeb && (
                <View style={styles.infoPill}>
                  <MaterialCommunityIcons name="information-outline" size={14} color={Colors.accentLight} />
                  <Text style={styles.infoPillText}>Ditado por voz chega no app nativo em breve</Text>
                </View>
              )}
            </View>
          </AnimatedEntrance>
...
const styles = StyleSheet.create({
  ...
  heroKicker: { fontSize: 12, fontWeight: '800', letterSpacing: 2, color: Colors.accentLight, marginBottom: Spacing.lg },
  ...
  transcriptLabel: { fontSize: 11, fontWeight: '800', letterSpacing: 1, color: Colors.accentLight, textTransform: 'uppercase', marginBottom: 6 },
