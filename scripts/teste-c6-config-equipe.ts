...
const clientesDesktop = ler('../src/screens/desktop/ClientesDesktopScreen.tsx');
...
assert.match(clientesDesktop, /gerenciar_clientes/, 'clientes desktop precisa aplicar o mesmo gate');
assert.match(clientesDesktop, /acesso restrito/, 'clientes desktop precisa explicar a restrição');
