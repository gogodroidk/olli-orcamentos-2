// CÓPIA VERBATIM da MATEMÁTICA do app: src/services/calculosOficio.ts (funções puras,
// sem React Native). NÃO reescreva as contas aqui — se o app mudar uma fórmula, re-copie
// este arquivo. A única alteração em relação à origem é o tipo VerticalId inline abaixo
// (a origem o importa de ./verticais; aqui ele é embutido para o painel não depender do
// módulo do celular). Ver docs/FERRAMENTAS_POR_NICHO.md para a base normativa de cada uma.
