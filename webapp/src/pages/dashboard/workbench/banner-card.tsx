					...
					<div className="col-span-2 md:col-span-1">
						<div className="flex flex-col gap-4">
							<Title as="h2" className="text-white">
								Bem-vindo à {GLOBAL_CONFIG.appName} 👋
							</Title>
							<Text className="text-white">
								Do orçamento ao recibo, sem planilha. Crie um orçamento, vire em ordem de serviço e deixe a
								IA te ajudar no diagnóstico — no celular e no computador.
							</Text>

							<Button
								variant="outline"
								className="w-fit bg-white text-black"
								onClick={() => window.open("https://olliorcamentos.online", "_blank")}
							>
								<Icon icon="solar:document-add-bold-duotone" size={24} />
								<span className="ml-2 font-black">Conhecer a OLLI</span>
							</Button>
						</div>
					</div>
