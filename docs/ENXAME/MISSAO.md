...
- **Onda 2 — Verdade & confiança** (próxima): consertar os P0 de maior alavancagem e menor risco de regressão (skeleton infinito Home, feature paga invisível EquipeAoVivo, mentira da FAQ landing, filtro KPI morto no painel, XSS no PDF do orçamento). Fan-out por clusters de arquivo disjuntos, gate verde por cluster, review + commit pelo coordenador.
