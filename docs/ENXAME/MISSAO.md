...
- **Onda 6 — QC VISUAL** (próxima, MAIN-THREAD): rodar o painel (`pnpm dev`, deps já instaladas) + landing, logar na demo (`demo@grtech.com.br`), tirar print das telas, catalogar bugs visuais (layout/ícone/espaçamento/contraste) em `CATALOGO_VISUAL.md`. Gera a próxima onda de correção. É o pedido nº1 do dono ("ver com olhos, print de todas as telas").
