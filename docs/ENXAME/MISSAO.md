...
- **Onda VOZ (design ✅):** quadro geral da conversa-por-voz em `OLLI_VOZ_CONVERSA.md`. Próximo passo: **Tier A** (Fase 0 mata preço-nulo→R$0 + melhorias single-shot seguras). Fase 2 (cota/preço) e Fase 3 (Tier B) esperam decisão do dono.
