...
- **Loop:** raiz "erro vira vazio" 100%, bugs de dado do painel do G3 fechados, Tier A de voz core pronto. Resta P2/P3 do painel (badge -darker, aria-labels, MenuDaLinha, deps antd), P2/P3 da re-auditoria, e as DECISÕES do dono (voz Fase 2/3, identidade visual, humanos). Próximas ondas = polish P2/P3 até o dono voltar.
