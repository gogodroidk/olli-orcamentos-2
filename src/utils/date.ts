...
/**
 * Capitaliza só a PRIMEIRA letra da string (resto intacto). Para datas longas
 * em pt-BR: "quinta-feira, 18 de junho" → "Quinta-feira, 18 de junho".
 * Use no lugar de `textTransform: 'capitalize'` (que capitaliza cada palavra,
 * deixando "De"/"Feira" errados).
 */
